...
pritaikius ADF testą AMZN akcijų duomenims gauti rezultatai:
...
% apie robota loseja rasyti projektiniame?
...
Prognozavimui naudojamas 90 procentų dumomenų rinkinio dydžio apmokymas modelio, o kitus 10\% bandoma prognozuoti po vieną reikšmę cikle kiekvieną
karta iš naujo apmokus modelį su tikra reikšmę. 
\subsection{ARIMA}
...
naudojamos ARIMA pagalbinės bibliotekos bei heuristins ARIMA algoritmas padedantis nustatyti geriausius ARIMA parametrus konkrečiam duomenų rinkiniui.
$Auto_arima$ funkcija pmdarima bibliotekoje Python naudoja statistinių testų ir heuristikų derinį, kad rastų geriausius ARIMA modelio parametrus. Funkcijos
rezultatas yra ARIMA klasė, kurioje yra $summary()$ metodas, kuris gali būti naudojamas peržiūrėti pasirinktus parametrus. Pavyzdžiui, galite naudoti $print(model.summary())$
norėdami atspausdinti pasirinktų parametrų santrauką.

BTCBUSD poros geriausi rasti parametrai p,d,q yra (2,1,2)
mse: 210.8316014022673
mape: 0.0006145148014448673

\begin{figure}[H]
  \centering
  \includegraphics[scale=0.5]{img/BTCBUSD_15m_dec_final.png}
  \caption{Prognozės ir tikrų verčių grafas}
  \label{fig:btcbusd_results}
\end{figure}

ETHBUSD poros geriausi rasti parametrai p,d,q yra (2,1,3)
ticker='ETHBUSD' results
mse: 1.6908145946915674
mape: 0.0008286163872857759

\begin{figure}[H]
  \centering
  \includegraphics[scale=0.5]{img/ETHBUSD_15m_dec_final.png}
  \caption{Prognozės ir tikrų verčių grafas}
...
%     \centering
%     % \includegraphics[width=.6\linewidth]{img/ETHBUSD_15m_dec_final.png}
%     \includegraphics[scale=0.5]{img/ETHBUSD_15m_dec_final.png}
%     \caption{Prognozės ir tikrų verčių grafas}
%     \label{fig:ethbusd_results}
%   \end{subfigure}%
%   % \begin{subfigure}{.5\textwidth}
%   %   \centering
%   %   \includegraphics[width=.6\linewidth]{img/ethbusd_plan.png}
%   %   \caption{Treniravimo ir testavimo dalis}
%   %   \label{fig:ethbusd_data}
%   % \end{subfigure}
%   % \caption{Visa reikšmė}
%   % \label{fig:ethbusd}
% \end{figure}
