...
\begin{itemize}
  ...
  \item Kadangi kainos nėra stacionarūs duomneys negalima naudoti paprastesnių AR, ARMA modelių,
  \item Geresni rezultatai gaunami naudojant ARIMA modelį nei SARIMA modelį,
  \item Galima naudoti modelius implementuoti strategiją robotui lošti.
\end{itemize}
